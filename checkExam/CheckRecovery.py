...
class ExamInfo:
    def __init__(self, row):
        ...
        # 袋数
        self.packNum = row.getValue(self.infoIndex[3])

    def getHeadValues(self):
        return ["试卷号","考试科目","份数","袋数"]
    
    def getValues(self):
        return [self.paperNo, self.paperName, self.num, self.packNum]
    ...
    def writeToFile(self):
        ...
        for info in self.infos:
            ...
            if baseInfo is None:
                ...
                baseValues = [baseInfo.paperNo, baseInfo.paperName, baseInfo.num, "1"]
